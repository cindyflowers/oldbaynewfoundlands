  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(Index, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          currentDog = _this$props.currentDog;
      var dog = dogs.filter(function (dog) {
        return dog.id == currentDog;
      });
      var myDogs;

      if (dog[0].rip == "") {
        myDogs = dogs.filter(function (d) {
      ...
      var startPosition = myDogs.findIndex(function (d) {
        return d.id == currentDog;
      });
      ...
      return __jsx(react__WEBPACK_IMPORTED_MODULE_8___default.a.Fragment, {
        ...
        return __jsx("div", {
          ...
          __self: this
        }))), _this2.state.display > 0 ? __jsx("div", {
          className: "table-responsive",
          __source: {
            fileName: _jsxFileName,
            lineNumber: 134
          ...
          __self: this
        }, awards.map.filter(function (dog) {
          return dog.id == data.id;
        })(function (data, idx) {
          return __jsx("tr", {
            __source: {
              fileName: _jsxFileName,
            ...
            __self: this
          }, __jsx(react_moment__WEBPACK_IMPORTED_MODULE_14___default.a, {
            format: "MMMM DD, YYYY",
            __source: {
              fileName: _jsxFileName,
              lineNumber: 146
...
//# sourceMappingURL=about.js.26a79cbc41b0fff8b19c.hot-update.js.map