  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(Index, [{
    ...
    value: function render() {
      ...
      if (this.state.display) {
        var _dog = this.props.dogs.filter(function (dog) {
          return dog.id == _this2.props.currentDog;
        });

        var _dogs;

        if (_dog[0].rip == "") _dogs = this.props.dogs.filter(function (d) {
          return _dog[0].sex == d.sex && d.ours == true && d.rip == "";
        });else _dogs = this.props.dogs.filter(function (d) {
          return d.ours == true && d.rip != "";
        });

        var startPosition = _dogs.findIndex(function (d) {
      ...
      return __jsx(react__WEBPACK_IMPORTED_MODULE_8___default.a.Fragment, {
        ...
        __self: this
      }, __jsx(OwlCarousel, Object(_babel_runtime_corejs2_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_0__["default"])({
        ...
        return __jsx("div", {
          ...
          __self: this
        }))), _this2.state.display && awards.length > 0 ? __jsx("div", {
          className: "table-responsive",
          __source: {
            fileName: _jsxFileName,
            lineNumber: 130
...
//# sourceMappingURL=about.js.bf53d178bad02b218595.hot-update.js.map